    ...
    return (
        <div>
            <div className='flex flex-col justify-center items-center mt-20'>
                <h2 className='font-bold text-3xl md:text-4xl'>Friends to keep close in your life</h2>
...
relationships that matter most.</p>
            ...
            <div className='grid grid-cols-1 md:grid-cols-4 gap-2 mt-8 mx-6'>
                {
            ...
            </div>
            {
             ...
             <div className='grid grid-cols-1 md:grid-cols-4 gap-2 mt-8 mx-6 p-10'>
